...
print("* iris types:", df["CLASSE"].unique(), sep="\n")
...
df2, targets = encode_target(df, "CLASSE")
print("* df2.head()", df2[["Target", "CLASSE"]].head(), sep="\n", end="\n\n")
print("* df2.tail()", df2[["Target", "CLASSE"]].tail(), sep="\n", end="\n\n")
